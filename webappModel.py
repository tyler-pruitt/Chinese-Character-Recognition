...
directory = '/Users/tylerpruitt/Desktop/Coding/chinese character recognition/data/data/'
...
trainImages, testImages = np.empty((int(15000*split), 64, 64), dtype=int), np.empty((15000 - int(15000*split), 64, 64), dtype=int)
